 ...
 */
  ...
  */
 function drool3_breadcrumb($breadcrumb) {
   if (!empty($breadcrumb)) {
...
function _phptemplate_variables($hook, $vars = array()) {  
  ...
  switch ($hook) {
    ...
    case 'page':
      ...
      if ($vars['node']->type) {
        ...
        $body_classes[] = 'ntype-'. drool3_id_safe($vars['node']->type);
      }
      // implode with spaces
    ...
    case 'node':
      ...
      $node_classes[] = 'ntype-'. drool3_id_safe($vars['node']->type);
      // implode with spaces
  ...
  if (function_exists('drool3_variables')) {
    $vars = drool3_variables($hook, $vars);
  }
...
*/
function drool3_id_safe($string) {
 ...
 */ 
function _drool3_default($hook, $variables, $suggestions = array(), $extension = '.tpl.php') {
  global $theme_engine;
  global $theme;
  global $theme_key;
