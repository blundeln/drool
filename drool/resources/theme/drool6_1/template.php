 ...
 *  the prefix from theme_ to drool6_1_.  For example:
 *
 *   original:  theme_breadcrumb() 
 *   theme override:   drool6_1_breadcrumb()
 *
 ...
 */
  ...
  */
 function drool6_1_breadcrumb($breadcrumb) {
   if (!empty($breadcrumb)) {
...
function phptemplate_preprocess_page(&$vars) {
  ...
  if ($vars['node']->type) {
    ...
    $body_classes[] = 'ntype-'. drool6_1_id_safe($vars['node']->type);
  }
  // implode with spaces
...
function xxx_phptemplate_variables($hook, $vars = array()) {  
  ...
  switch ($hook) {
    ...
    case 'node':
      ...
      $node_classes[] = 'ntype-'. drool6_1_id_safe($vars['node']->type);
      // implode with spaces
  ...
  if (function_exists('drool6_1_variables')) {
    $vars = drool6_1_variables($hook, $vars);
  }
...
*/
function drool6_1_id_safe($string) {
 ...
 */ 
function xxx_drool6_1_default($hook, $variables, $suggestions = array(), $extension = '.tpl.php') {
  global $theme_engine;
  global $theme;
  global $theme_key;
...
function phptemplate_links($links, $attributes = array('class' => 'links'), $skin=False) {
  ...
  * In drool, we use this to put skins around primary links.
  */
